...
public class HostGUI extends Application{
	...
	public void start(Stage primaryStage) throws Exception {
		...
		Scene newPartyScene = new Scene(newPartyPane,500,350);
		...
		newPartyPane.getChildren().addAll(list, newPartyLabel, newPartyNameLabel, newPartySizeLabel, newPartyNameField, newPartySizeField, rb1, rb2,ageAdultButton, ageFreeButton, ageFourButton, ageSixButton, ageNineButton);
